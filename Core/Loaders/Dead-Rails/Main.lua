...
local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/AF28s/Null-Fire/main/Core/Libraries/Fire-Lib/Main.lua", true))()
local espLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/AF28s/Null-Fire/main/Core/Libraries/ESP/Main.lua", true))()
local txtf = loadstring(game:HttpGet("https://raw.githubusercontent.com/AF28s/Null-Fire/main/Core/Libraries/Side-Text/Main.lua", true))()
local tpToEnd = loadstring(game:HttpGet("https://raw.githubusercontent.com/AF28s/Null-Fire/refs/heads/main/Core/Loaders/Dead-Rails/TeleportToEnd.lua", true))()
